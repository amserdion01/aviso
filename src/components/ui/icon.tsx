/**
 * Inline Lucide icon set — only the glyphs the Aviso screens use, copied as raw
 * SVG path markup so we ship zero icon dependencies. Add new entries to ICONS
 * as needed (path data from https://lucide.dev).
 */
